...
public interface Emotes {
    ...
    //subtypes
    String water_ = "<:water:833027248495788032>";
    String psychic_ = "<:psychic:833027248462364682>";
    String metal_ = "<:metal:833027248297738240>";
    String lightning_ = "<:lightning:833027248364847114>";
    String grass_ = "<:grass:833027248575348756>";
    String fire_ = "<:fire:833027248512696331>";
    String fighting_ = "<:fighting:833027248630136882>";
    String fairy_ = "<:fairy:833027247950528563>";
    String dragon_ = "<:dragon:833027248331685988>";
    String darkness_ = "<:darkness:833027248344924180>";
    String colorless_ = "<:colorless:833027248348332102>";
    ...
    String originalBagde_ = "<:OriginalCollector:1058979218517667850>";
